...
#include "../include/scoring2D_i0.hpp"
...
template <typename T, typename IOType> 
class childscoringi0: public scoring2D_i0<T, IOType>{
...
PYBIND11_MODULE(Ladder_3_i0, m){
    py::class_<childscoringi0<PreciseType, long double>>(m, "Ladder_3_i0", py::module_local())
        .def(py::init())
        .def("getLaplacian",          &childscoringi0<PreciseType, long double>::get_laplacian)
        .def("setLaplacian_ladder_3", &childscoringi0<PreciseType, long double>::set_ladder_3_laplacian)
        .def("get_FPT_stat",          &childscoringi0<PreciseType, long double>::get_Mean_CV_FPT)
        .def("getSteadyState",        &childscoringi0<PreciseType, long double>::get_steady_state)
        .def("compute_response",      &childscoringi0<PreciseType, long double>::Response_class)  
        .def("mult_laplacian_TF",     &childscoringi0<PreciseType, long double>::set_laplacian_TF_class) 
        .def("getLaplacianTF",        &childscoringi0<PreciseType, long double>::get_laplacian_TF)
        .def("simple_score",          &childscoringi0<PreciseType, long double>::SimpleScore, 
                                        py::arg("TF_range_for_score"), py::arg("n_TF_conc_points"), py::arg("low_acc"), py::arg("up_acc"))
        .def("triming",               &childscoringi0<PreciseType, long double>::trim_range_response, 
                                        py::arg("TF_range"), py::arg("n_points"), py::arg("deltaTH"))
        .def("redef_score_RESP",      &childscoringi0<PreciseType, long double>::redef_score_RESP, 
                                        py::arg("n_points"), py::arg("deltaTH"), py::arg("low_acc"), py::arg("up_acc"))
        .def("redef_score_noRESP",    &childscoringi0<PreciseType, long double>::redef_score_noRESP, 
                                        py::arg("TF_range_noresp"), py::arg("n_points"), py::arg("deltaTH"), py::arg("low_acc"), py::arg("up_acc"))
        .def("monotonicity",          &childscoringi0<PreciseType, long double>::monotonicity_test,
                                        py::arg("range_to_check"), py::arg("n_points_for_ss"), py::arg("delta_TH"))        
        .def("score_no_response",     &childscoringi0<PreciseType, long double>::scoreNoResponse, 
                                        py::arg("TF_range_for_score"), py::arg("n_points_for_ss"), py::arg("delta_TH"), py::arg("low_acc"), py::arg("up_acc"))      
        .def("score_response",        &childscoringi0<PreciseType, long double>::scoreWithResponse,
