...
outfname = "./results/results_gt0_" <> First[StringSplit[$CommandLine[[4]], "_"]] <> "_" <> conditionString <> ".csv";
timec = 1000;
...
While[Not[SameQ[line, EndOfFile]],
    ...
    *)
    ...
    If[out1 === True || out1 === False,
        ...
        With[{assum = customCondition}, out1 = Simplify[Reduce[assum \[Implies] out1, Reals], assum]]
    ]
